...
const PlacesPage = () => {
  ...
  const uploadPhoto = async (e) => {
    ...
    axios.post("/uploads-from-pc", data, {
              ...
              addedPhotos.map((link) => (
                <div>
                  <img
                    ...
                    alt="img"
                    className="rounded-xl  border border-black h-20"
                  />
                </div>
              ))}
            <label className="cursor-pointer flex items-center justify-center gap-2 p-5 border border-gray-400 bg-transparent  m-1 rounded-xl px-5">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
